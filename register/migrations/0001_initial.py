# Generated by Django 2.1.7 on 2019-04-09 14:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Net_worth', models.BooleanField(verbose_name='networth tell man!')),
        ...
        migrations.AddField(
            ...
            name='event_id',
            field=models.ForeignKey(on_delete='CASCADE', to='register.event_creation'),
        ),
        migrations.AddField(
            model_name='event_contrib',
            name='user',
